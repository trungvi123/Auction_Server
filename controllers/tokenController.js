...
const refreshTokenMethod = async (req, res) => {
    ...
    const userPayload = {
        ...
        emailPaypal: decodedRefreshToken.emailPaypal || '',
        productPermission: decodedRefreshToken.createdProduct,
        freeProductPermission: decodedRefreshToken.createdFreeProduct
    };
